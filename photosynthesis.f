...
c     Collatz et al 1991, Collatz et al 1992 and Haxeltine & Prentice 1996
      ...
      subroutine photosynthesis(ca,temp,fpar,par,dayl,c4,
...
c     ARGUMENTS
      real lambda,par,dayl,temp,rd,agd,adtmm,ca,fpar
      logical c4
      real x1,x2,x3,x4
      integer pfti
...
c     LOCAL VARIABLES
      ...
      real s,sigma,vm,and,pa,je,jc,t0,adt
      real tstress,k1,k2,k3,low,high,lambdam(1:npft)
      integer i
