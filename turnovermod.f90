...
subroutine turnover(pftpar,present,lm_ind,sm_ind, hm_ind,rm_ind,litter_ag_fast,litter_bg,nind,turnover_ind)
...
do pft=1,npft
  ...
  l_torate = 1. / pftpar(pft,9)
  s_torate = 1. / pftpar(pft,11)
  r_torate = 1. / pftpar(pft,12)
